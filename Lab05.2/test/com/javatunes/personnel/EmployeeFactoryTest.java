...
public class EmployeeFactoryTest {
     ...
     */
    @Test
    public void createEmployee_shouldCreateSalariedEmployee_whenPassedSE() {

        Employee emp = EmployeeFactory.createEmployee(seMap);
        SalariedEmployee semp = (SalariedEmployee) emp;
        System.out.println();
        assertEquals(SalariedEmployee.class, semp.getClass());
     ...
     */
    @Test
    public void createEmployee_shouldCreateHourlyEmployee_whenPassedHE() {
        // TODO
        ...
        assertEquals(40, hemp.getHours(), .001);
        assertEquals(2000, hemp.getHours() * hemp.getRate(), .001);
    }

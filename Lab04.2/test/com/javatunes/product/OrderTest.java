...
public class OrderTest {
    ...
    public void testProcessCart() {
        ...
        order1.processCart(productCart); // this is a shopping cart of <Product>
        System.out.println();

        Order order2 = new Order("order-2");
        order2.processCart(musicCart);  // this is a shopping cart of<MusicItem>
        System.out.println();

        Order order3 = new Order("order-3");
        order3.processCart(mediaCart);  // this is a shopping cart of <MediaPlayer>
        System.out.println();

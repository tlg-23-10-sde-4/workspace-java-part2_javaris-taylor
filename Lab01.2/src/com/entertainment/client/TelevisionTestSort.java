...
import com.entertainment.TelevisionBrandChanComparator;
...
public class TelevisionTestSort {
  ...
  public static void main(String[] args) {
    ...
    // new comparator test
    tvList.sort(new TelevisionBrandChanComparator());
    System.out.println("Sorted by brand, then channel if same");
    dump(tvList);
  }

  private static void dump(List<Television> televisions) {
